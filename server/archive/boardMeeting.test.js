...
let elem = {Symbol: 'Rel', Purpose:"Test", waste: "dont want"}
    let symbol, purpose,boardMeetingDate
  let  newElem = {Symbol:symbol,Purpose:purpose,boardMeetingDate='hi'  } = elem

console.log(`new elem is ${JSON.stringify(newElem)}`);
